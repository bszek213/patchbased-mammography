...
def main():
    ...
    for type_patch in type_patch_total:
        for multiply in multiplication_values:
            ...
            #create model res
            if not os.path.exists(f'patch_ResNet152_{type_patch}_patches_{str(multiply)}.h5'):
            ...
            #create model dense
            if not os.path.exists(f'patch_dense121_{type_patch}_patches_{str(multiply)}.h5'):
